...
type Page = 'login' | 'register' | 'dashboard' | 'surat_pengantar' | 'surat_undangan' | 'surat_keputusan'; 
...
function App() {
  ...
  const handleOpenSuratUndangan = () => {
    setCurrentPage('surat_undangan');
  };

  const handleOpenSuratKeputusan = () => {
    setCurrentPage('surat_keputusan');
  };
